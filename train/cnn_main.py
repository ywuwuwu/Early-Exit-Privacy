...
from branchyCNN import CNNCifar
from branchyCNN import branchy_CNNCifar
from branchyCNN import branchy_CNNCifar_inference
...
# Create the BranchyNet CNN model
print('branchy cnn')
model = branchy_CNNCifar(args)
model_inference = branchy_CNNCifar_inference(args)
input_shape = (1,32, 32, 3)
model.build(input_shape)

model_inference.build(input_shape)
callback = PrivacyMetrics(epochs_per_report, "branchy cnn", model_inference)
callback = training_loop(x_train, y_train, x_test,y_test,callback, model,model_inference,optimizer, metric, metric_test, batch_size = batch_size, total_epochs = total_epochs, lr = lr)
...
callback = PrivacyMetrics(epochs_per_report, "cnn")
...
epoch_plot.savefig('results/branchy/cnn_epoch_plot.pdf')
...
utility_privacy_plot.savefig('results/figures/cnn_utility_privacy.pdf')
